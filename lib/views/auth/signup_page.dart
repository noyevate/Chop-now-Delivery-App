...
import 'package:chopnow_driver/common/controllers/registration_controller.dart';
...
import 'package:chopnow_driver/models/signup_model.dart';
import 'package:chopnow_driver/views/auth/login_page.dart';
import 'package:chopnow_driver/views/auth/widget/email_textfield.dart';
import 'package:chopnow_driver/views/auth/widget/password_textfield.dart';
          ...
          children: [
            ...
            Padding(
              ...
              children: [
                ...
                ReuseableText(title: "Delivery", style: TextStyle(color: Tcolor.gray)),
              ],
            ),
                  ...
                  CustomButton(
                    ...
                    onTap: () {
                      if (_emailController.text.isNotEmpty &&
                          ...
                          _passwordController.text.length >= 8 && _selectedUserType == "Driver") {
